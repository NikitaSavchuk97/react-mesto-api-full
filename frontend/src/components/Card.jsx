...
function Card({ card, illustrationClick, onCardLike, onConfirmOpen, onConfirm }) {
	...
	return (
		<article className="element">
			...
			<button type="button" onClick={() => handleDeleteClick(card)} className={cardDeleteButtonClassName}></button>
		</article>
	)
}
